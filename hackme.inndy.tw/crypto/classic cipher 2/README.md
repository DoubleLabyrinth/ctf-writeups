# hackme.inndy.tw --- crypto --- classic cipher 2
...
Go to [https://www.mygeocachingprofile.com/codebreaker.vigenerecipher.aspx](https://www.mygeocachingprofile.com/codebreaker.vigenerecipher.aspx) 

with option `No, try to determine key and message based on analysis of encrypted text.` to decrypt.

You will find the key is
